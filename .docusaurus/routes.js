...
export default [
  {
    ...
    routes: [
      ...
      {
        path: '/docs/Introduction/contribution',
        component: ComponentCreator('/docs/Introduction/contribution', '023'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
      ...
      {
        path: '/docs/Introduction/necessary-knowledge',
        component: ComponentCreator('/docs/Introduction/necessary-knowledge', '947'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
        path: '/docs/Introduction/roles-responsibilities',
        component: ComponentCreator('/docs/Introduction/roles-responsibilities', '3f8'),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
